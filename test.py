...
def initialize_rag_chain():
    try:
        ...
        system_context = (
            "You are an AI-powered fraud detection assistant named 'Fraud Suraksha'. "
            "Your goal is to analyze user queries and assess if they are experiencing a scam. "
            "Use the provided context to identify common scam patterns and assign a fraud risk score. "
            "If you don't have enough data, ask relevant follow-up questions to gather more details. "
            "Once you detect a fraud type, provide a clear explanation, risk assessment, and actionable steps. "
            "Always include official fraud reporting resources and emergency contact details. "
            "Never generate fake information, legal advice, or unverifiable claims. "
            "Format your responses in a clear, structured way with emojis and sections. "
            "For confirmed scams, always include a Fraud Risk Report with: "
            "📌 Fraud Type, 📌 Fraud Risk Score, 📌 Explanation, and 🚨 Recommended Actions. "
            "Include official resources like the Indian Cyber Crime Portal (https://cybercrime.gov.in) (https://sancharsaathi.gov.in)"
            "and the Cyber Fraud Helpline (1930) when relevant. "
            "\n\n"
            "{context}"
        )
...
if prompt := st.chat_input("What suspicious activity would you like me to evaluate?"):
    ...
    with st.chat_message("assistant"):
        if not rag_chain_result:
            ...
            fallback_response = (
                "⚠️ I'm currently having trouble connecting to my knowledge base. "
                ...
                "📞 Important Contacts:\n"
                "- Indian Cyber Crime Portal: https://cybercrime.gov.in , https://sancharsaathi.gov.in \n"
            ...
            try:
                ...
                error_response = (
                    "⚠️ I apologize, but I'm experiencing technical difficulties at the moment. "
                    "Please try again with your question. If the problem persists, here are some general "
                    "guidelines about spotting fraud:\n\n"
                    "🚨 General Safety Guidelines:\n"
                    "- Be cautious with unexpected messages or calls\n"
                    "- Verify identities through official channels\n"
                    "- Don't share personal information unless you're certain it's legitimate\n"
